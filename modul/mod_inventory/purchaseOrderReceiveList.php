...
$start_from = ($page-1) * $limit;
	echo"			
		...
		$cekpor = mysql_query("select * from item_transaction where TRANSACTION_CODE = '002' ORDER BY item_transaction.TRANSACTION_NO DESC LIMIT $start_from, $limit");
		while($por = mysql_fetch_array($cekpor)){
            ...
            echo"
                <li><a href='albatsiq.php?module=inventory&act=purchaseOrderReceiveList&page=1'>First</a></li>
                <li><a href='albatsiq.php?module=inventory&act=purchaseOrderReceiveList&page=$link_prev'>&laquo;</a></li>
            ";
            }
			...
			$resut = mysql_query("select * from item_transaction where TRANSACTION_CODE = '002' ORDER BY item_transaction.TRANSACTION_NO DESC");
            ...
            echo" <li $link_active><a href=albatsiq.php?module=inventory&act=purchaseOrderReceiveList&page=".$i.">".$i."</a></li>";
            }
            ...
            echo"
                <li><a href='albatsiq.php?module=inventory&act=purchaseOrderReceiveList&page=$link_next'>&raquo;</a></li>
                <li><a href='albatsiq.php?module=inventory&act=purchaseOrderReceiveList&page=$jumlah_page'>Last</a></li>
            ";
            }
   echo"         
</ul>";
