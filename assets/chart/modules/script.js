$(function () {
    ...
    function pageLoadGraph(){
      ...
      console.log(mod);
      $.getJSON('templates/Templates/getGraphModule', '', function(response_data) {
        html = '';
        $.each(response_data, function (i, o) {
          html += '<div class="col-sm-'+o.col_size+'"><div id="'+o.nameid+'"></div></div>';
          if(o.style=='column'){
            GraphColumnStyle('', o.nameid, o.url);
          }
          if(o.style=='pie'){
            GraphPieStyle('', o.nameid, o.url);
          }
          if(o.style=='line'){
            GraphLineStyle('', o.nameid, o.url);
          }
          if(o.style=='table'){
            GraphTableStyle('', o.nameid, o.url);
          }
