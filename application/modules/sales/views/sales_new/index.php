...
<div>    
    ...
    <div class="clearfix" style="margin-bottom:10px;text-align:left;">
      <?php echo $this->authuser->show_button('sales/sales_new','C','',1)?>
      <div class="pull-right tableTools-container"></div>
    </div>

        <table id="dynamic-table" base-url="sales/sales_new" class="display table table-striped table-bordered table-hover" width='100%' >
            <thead>
                <tr>
                    <th width='5%'></th>
                    <th width='15%'> Sales No. </th>
                    <th width='10%'> Date  </th>
                    <th width='10%'> Note </th>
