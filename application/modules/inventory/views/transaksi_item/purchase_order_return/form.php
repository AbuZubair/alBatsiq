    ...
    $('#form_item_trans').ajaxForm({
      ...
      complete: function(xhr) {     
        ...
        if(jsonResponse.status === 200){
          ...
          $('#page-area-content').load('inventory/transaksi_item/purchase_order_return?_=' + (new Date()).getTime());
        }else{
          $.achtung({message: jsonResponse.message, timeout:5});
        }
        achtungHideLoader();
...
$('#btn_search_data').click(function (e) {      
	...
	if( $("#form_cari_pasien").val() == "" ){
		...
		$.getJSON("<?php echo site_url('Templates/References/getPORbyTgl') ?>/" + $('#from_tgl').val() +"/" +  $('#to_tgl').val(), '', function (data) {              
			...
			if( data.count == 0){
				...
				$("#result_POR tr").remove();

				$.each(data, function (i, o) {                  


						$('<tr><td>'+o.transaction_no+'</td><td>'+o.transaction_date+'</td><td>'+o.note+'</td><td align="center"><a href="#" class="btn btn-xs btn-pink" onclick="select_por_from_modal('+"'"+o.transaction_no+"'"+')"><i class="fa fa-arrow-down"></i>Pilih</a></td></tr>').appendTo($('#result_POR'));                    
...
function outstanding() {
	...
	$.getJSON("<?php echo site_url('Templates/References/getPOR') ?>/" + $('#insertlocunit').val(), '', function (data) {              
...
function select_por_from_modal(por_no){	

		$("#modalPOR").modal('hide');

    $('#insertReferenceNo').val(por_no);

    $('#insertReferenceNo').text(por_no); 

		$.getJSON("<?php echo site_url('Templates/References/getPORDetail') ?>/" + por_no, '', function (data) {              
...
<div class = 'title-container'>
    <div class = "txttitle" >
        <h1 style="margin-top:10px;margin-left:10px;">Purchase Order Return</h1>
    </div>
</div>
  ...
  <div class="col-xs-12">
    <!-- PAGE CONTENT BEGINS -->
          <div class="widget-body">
            ...
            <div class="row">
            <form class="form-horizontal" method="post" id="form_item_trans" action="inventory/transaksi_item/purchase_order_return/process" enctype="multipart/form-data">
                <div class="col-lg-6"> 

                  <div class="form-group">
                    <label class="control-label col-md-4">Purchase Order Return No.</label>
                    <div class="col-md-4">
                      <input name='retnumber' id='retnumber' value='<?php echo isset($value)?$value->transaction_no:$trans_no?>' placeholder="" class="form-control" type="text" readonly>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
									...
									<div class="form-group" id="outstanding" <?php echo ($flag!='read')?'style="display:none;"':''?>>
										<label class="control-label col-md-4">Receive Order No</label>
                    <div class="col-md-8">
              ...
              <table width='100%' id='record'>
                ...
                <div class="form-actions" style="text-align:center;">
                  ...
                  <a onclick="getMenu('inventory/transaksi_item/purchase_order_return')" href="#" class="btn btn-sm btn-success">
...
<div id="modalPOR" class="modal fade" tabindex="-1">
