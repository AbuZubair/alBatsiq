...
<div>    
    ...
    <div class="clearfix" style="margin-bottom:10px;text-align:left;">
      <?php echo $this->authuser->show_button('inventory/transaksi_item/purchase_order_receive','C','',1)?>
      <div class="pull-right tableTools-container"></div>
    </div>

        <table id="dynamic-table" base-url="inventory/transaksi_item/purchase_order_receive" class="display table table-striped table-bordered table-hover" width='100%' >
            <thead>
                <tr>
                    <th width='5%'></th>
                    <th width='15%'> Purchase Order Receive No. </th>
                    <th width='10%'> Date  </th>
                    <th width='10%'> Note </th>
