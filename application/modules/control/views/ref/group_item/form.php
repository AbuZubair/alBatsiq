    ...
    $('#form_group_item').ajaxForm({
      ...
      complete: function(xhr) {     
        ...
        if(jsonResponse.status === 200){
          ...
          $('#page-area-content').load('control/ref/group_item?_=' + (new Date()).getTime());
        }else{
          $.achtung({message: jsonResponse.message, timeout:5});
        }
        achtungHideLoader();
    ...
    <!-- PAGE CONTENT BEGINS -->
          <div class="widget-body">
            <div class="widget-main no-padding">
              <form class="form-horizontal" method="post" id="form_group_item" action="<?php echo site_url('control/ref/group_item/process')?>" enctype="multipart/form-data">
                <br>

                <div class="form-group">
                  <label class="control-label col-md-2">Group ID</label>
                  <div class="col-md-1">
                    <input name="id" id="id" value="<?php echo isset($value)?$value->group_item_id:0?>" placeholder="Auto" class="form-control" type="text" readonly>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-2">
                    <input name="group_name" id="group_name" value="<?php echo isset($value)?$value->group_name:''?>" placeholder="" class="form-control" type="text" <?php echo ($flag=='read')?'readonly':''?> >
                  </div>
                </div>
                ...
                <div class="form-actions center">
                  ...
                  <a onclick="getMenu('control/ref/group_item')" href="#" class="btn btn-sm btn-success">
